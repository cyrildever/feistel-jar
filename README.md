...
```
feistel 1.4.0
Usage: java -cp feistel-jar-1.4.0.jar fr.edgewhere.feistel.Main [options] <input>
...
eg.
```console
$ java -cp path/to/feistel-jar-1.4.0.jar fr.edgewhere.feistel.Main 'myWordToObfuscate'
```

#### Library

```sbt
libraryDependencies += "fr.edgewhere" %% "feistel_2.12" % "1.4.0"
```
